...
//
//     final verifyAuthPaymentModel = verifyAuthPaymentModelFromJson(jsonString);

import 'dart:convert';

VerifyAuthPaymentModel verifyAuthPaymentModelFromJson(String str) =>
    VerifyAuthPaymentModel.fromJson(json.decode(str));

String verifyAuthPaymentModelToJson(VerifyAuthPaymentModel data) =>
    json.encode(data.toJson());

class VerifyAuthPaymentModel {
  VerifyAuthPaymentModel({
  ...
  factory VerifyAuthPaymentModel.fromJson(Map<String, dynamic> json) =>
      VerifyAuthPaymentModel(
        status: json["status"],
