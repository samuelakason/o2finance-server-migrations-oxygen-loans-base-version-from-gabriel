...
class ChangePinCheck extends StatefulWidget {
  ChangePinCheck({Key? key}) : super(key: key);

  @override
  _ChangePinCheckState createState() => _ChangePinCheckState();
}

class _ChangePinCheckState extends State<ChangePinCheck> {
  List codeEntry = [];
  ...
  displayLoaderCircle() {
    ...
    if (completedDigit == localPin) {
      Route route = MaterialPageRoute(builder: (_) => ChangePin());
