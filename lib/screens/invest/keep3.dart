...
// class Keep3 extends StatefulWidget {
//   Keep3({Key? key, required this.investementAmount, required this.period})
//       : super(key: key);
//   final String investementAmount;
//   final String period;

//   @override
//   _Keep3State createState() => _Keep3State();
// }

// class _Keep3State extends State<Keep3> {
//   String mPerido = "";
//   String iRate = "15%";
//   String iValue = "";
//   String tAmount = "";
...
//     DocumentReference documentReference = OxygenApp.firestore
//         .collection("users")
//         .doc(userID)
//         .collection("investements")
//         .doc();
//     documentReference.set({
//       "investmentID": documentReference.id,
//       "user": userID,
//       "type": "02 keep",
//       "period": widget.period,
//       "principal": widget.investementAmount,
//       "interest": iValue,
//       "totalReturns": tAmount,
//       "interesetRate": "20%",
//       "status": "0",
//       "maturitDate": DateTime.now()
//           .add(Duration(days: 0, hours: 0, minutes: 1))
//           .toString(),
//     }).then((value) async {
//       var loanDetails =
...
//           double.parse(loanDetails["investment"].toString());
