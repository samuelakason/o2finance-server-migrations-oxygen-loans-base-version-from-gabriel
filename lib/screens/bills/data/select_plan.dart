...
class SelectDataPlan extends StatelessWidget {
  SelectDataPlan({Key? key}) : super(key: key);
                    ...
                    controller.loadingdataPlans
                        ...
                        : SizedBox(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount:
                                  controller.dataVariatiosModel.data.length,
                              itemBuilder: (BuildContext context, int index) {
                                var data =
                                    controller.dataVariatiosModel.data[index];
                                return InkWell(
                                    onTap: () {
